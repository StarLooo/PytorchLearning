...
def train(train_features, test_features, train_labels, test_labels, num_epochs=400):
    ...
    train_iter = utils.load_array((train_features, train_labels.reshape(-1, 1)),
                                  batch_size)
    test_iter = utils.load_array((test_features, test_labels.reshape(-1, 1)),
    ...
    print('train weight:', net[0].weight.data.numpy())
